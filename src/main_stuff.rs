            ...
            let result: anyhow::Result<()> = (|| {
                ...
                for entry in &entries {
                    let result: anyhow::Result<()> = (|| {
                        ...
                        if !entry.path.ends_with(".pck") && !entry.path.ends_with(".bnk") {
                            return Ok(());
                        }

                        // let Ok(uuid) = Uuid::parse_str(
                        ...
                        //     &mut decompressed
                        //         [mip.data_offset.pos as usize..mip.data_end.pos as usize],
                        // )
                        ...
                        // let image_data =
                        //     texture_converter.convert(&texture_data, &texture_header)?;
